...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    label.text = [NSString stringWithFormat:@"%@ %li栋%li单元%li", propertyCell.house.housingEstatename, (unsigned long)(propertyCell.house.buildingNo), (unsigned long)propertyCell.house.unitNo, (unsigned long)propertyCell.house.roomNo];
